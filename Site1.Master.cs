        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["role"].Equals(""))
                {
                    ...
                    LinkButton7.Visible = false; //welcome user login link button
                ...
                else if (Session["role"].Equals("user"))
                {
                    ...
                    LinkButton7.Visible = true; //welcome user login link button
                    LinkButton7.Text = "Welcome,  " + Session["fullname"].ToString();
